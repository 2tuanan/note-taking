...
const Header = () => {
    ...
    return (
        <header className='bg-[#f5ba13] mx-0 py-4 px-2 sm:px-5 shadow-md text-[#fff]'>
            <div className='ml-0 rounded-md h-[65px] flex justify-between items-center px-5 transition-all' >
                ...
                <div className='flex justify-center items-center gap-3'>
                    ...
                    {isDropdownOpen && (
                        <div className='z-10 group absolute top-[97px] right-0 bg-white shadow-md rounded-lg w-48 border border-[#f5ba13] hover:border-red-400/80 hover:bg-red-400 transition-all duration-300'>
